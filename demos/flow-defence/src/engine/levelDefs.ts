...
export const LEVELS: readonly LevelConfig[] = [
  ...
  },
  {
    ...
    waves: [
      ...
      { count: 19, hp: 2.6, interval: 12, arms: [0, 1, 2], types: ['standard', 'swimmer', 'phantom'], surge: true },
      { count: 14, hp: 3.2, interval: 13, arms: [0, 1, 2], types: ['sinker', 'phantom'] },
      { count: 22, hp: 3.2, interval: 11, arms: [0, 1, 2], types: ['standard', 'swimmer', 'splitter'], surge: true },
      { count: 19, hp: 3.7, interval: 11, arms: [0, 1, 2], types: ['swimmer', 'splitter', 'phantom', 'sinker'] },
      { count: 27, hp: 4.0, interval: 9, arms: [0, 1, 2], types: ['standard', 'swimmer', 'splitter', 'phantom', 'sinker'], surge: true },
    ],
  },
]
