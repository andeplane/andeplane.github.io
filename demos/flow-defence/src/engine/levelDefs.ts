...
export const LEVELS: readonly LevelConfig[] = [
  ...
  },
  {
    ...
    waves: [
      { count: 8, hp: 1.2, interval: 26, arms: [0, 1, 2] },
      { count: 10, hp: 1.6, interval: 22, arms: [0, 1, 2], types: ['standard', 'swimmer'] },
      { count: 4, hp: 1.8, interval: 48, arms: [1], types: ['sinker'] },
      { count: 13, hp: 2.1, interval: 18, arms: [0, 1, 2], surge: true },
      { count: 11, hp: 2.3, interval: 20, arms: [0, 2], types: ['standard', 'sinker'] },
      { count: 14, hp: 2.6, interval: 15, arms: [0, 1, 2], types: ['swimmer', 'sinker'], surge: true },
      { count: 18, hp: 3.0, interval: 13, arms: [0, 1, 2], types: ['standard', 'swimmer', 'sinker'], surge: true },
    ],
  },
  {
    name: 'The Delta',
    ...
    waves: [
      ...
      { count: 5, hp: 1.8, interval: 37, arms: [1], types: ['splitter'] },
      { count: 13, hp: 1.9, interval: 20, arms: [0, 2], types: ['standard', 'splitter'] },
      { count: 11, hp: 2.3, interval: 18, arms: [0, 1, 2], types: ['splitter', 'swimmer'], surge: true },
      { count: 14, hp: 2.5, interval: 15, arms: [0, 1, 2], types: ['standard', 'splitter'] },
      { count: 16, hp: 2.8, interval: 13, arms: [0, 1, 2], types: ['splitter', 'sinker'], surge: true },
    ],
  },
  {
    name: 'Maelstrom',
    ...
    waves: [
      { count: 16, hp: 1.1, interval: 15, arms: [0, 1, 2] },
      { count: 22, hp: 1.1, interval: 11, arms: [0, 2], types: ['standard', 'swimmer'] },
      { count: 6, hp: 2.1, interval: 24, arms: [1], types: ['splitter'] },
      { count: 29, hp: 1.3, interval: 9, arms: [0, 1, 2], surge: true },
      { count: 24, hp: 1.6, interval: 10, arms: [0, 1, 2], types: ['standard', 'swimmer', 'splitter'] },
      { count: 35, hp: 1.8, interval: 8, arms: [0, 1, 2], types: ['standard', 'swimmer'], surge: true },
    ],
  },
  {
    name: 'Blackwater',
    ...
    waves: [
      { count: 10, hp: 1.6, interval: 22, arms: [0, 1, 2] },
      { count: 6, hp: 1.4, interval: 29, arms: [1], types: ['phantom'] },
      ...
      { count: 12, hp: 2.4, interval: 14, arms: [0, 1, 2], types: ['phantom', 'swimmer', 'splitter'], surge: true },
    ],
  },
  {
    name: 'The Locks',
    ...
    waves: [
      { count: 11, hp: 1.8, interval: 20, arms: [0, 1, 2] },
      { count: 13, hp: 2.1, interval: 16, arms: [0, 1, 2], types: ['standard', 'swimmer'] },
      { count: 8, hp: 2.5, interval: 22, arms: [0, 2], types: ['sinker', 'phantom'] },
      { count: 14, hp: 2.6, interval: 14, arms: [0, 1, 2], types: ['splitter', 'swimmer'], surge: true },
      { count: 13, hp: 3.0, interval: 14, arms: [0, 1, 2], types: ['phantom', 'sinker'] },
      { count: 18, hp: 3.3, interval: 12, arms: [0, 1, 2], types: ['standard', 'swimmer', 'splitter'], surge: true },
      { count: 21, hp: 3.7, interval: 11, arms: [0, 1, 2], types: ['swimmer', 'splitter', 'phantom', 'sinker'], surge: true },
    ],
  },
  {
    name: 'The Throat',
    ...
    waves: [
      { count: 13, hp: 1.9, interval: 18, arms: [0, 1, 2] },
      { count: 16, hp: 2.3, interval: 14, arms: [0, 1, 2], types: ['standard', 'swimmer'] },
      { count: 10, hp: 2.6, interval: 18, arms: [0, 2], types: ['splitter', 'sinker'] },
      { count: 16, hp: 2.3, interval: 13, arms: [0, 1, 2], types: ['standard', 'swimmer', 'phantom'], surge: true },
      { count: 11, hp: 2.9, interval: 14, arms: [0, 1, 2], types: ['sinker', 'phantom'] },
      { count: 18, hp: 2.9, interval: 12, arms: [0, 1, 2], types: ['standard', 'swimmer', 'splitter'], surge: true },
      { count: 16, hp: 3.3, interval: 12, arms: [0, 1, 2], types: ['swimmer', 'splitter', 'phantom', 'sinker'] },
      { count: 22, hp: 3.6, interval: 10, arms: [0, 1, 2], types: ['standard', 'swimmer', 'splitter', 'phantom', 'sinker'], surge: true },
    ],
  },
]
