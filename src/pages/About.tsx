...
export default function About() {
  return (
    <div className="personal-intro personal-intro-about">
      <img className="personal-portrait" src={portrait} alt="Anders Hafreager" width={2000} height={3000} />
      <div className="personal-intro-copy" style={{ maxWidth: '680px' }}>
        ...
        >
          <p>
            I'm Anders Hafreager, Vice President of Engineering at <a href="https://www.cognite.com" target="_blank" rel="noopener noreferrer">Cognite</a>. I care about building strong engineering teams and software that solves real industrial problems — applying AI on industrial data to help people make sense of complex systems and improve their day-to-day work.
          </p>

          <p>
            Maths and physics are a big part of what keeps me curious. I like following an idea from the equations to a simulation I can explore and share. I have a PhD in computational physics from the University of Oslo, where I built molecular dynamics simulators and studied the behaviour of fluids at the nanoscale. These days I apply that background to making complex simulations accessible in the browser — and to leading engineering teams building industrial software.
          </p>
          ...
          <p>
            I live in Nydalen, Oslo with my wonderful girlfriend Ingrid and my six-year-old son Ludwig. When I'm not in front of a computer I'm probably hiking with Ludwig, listening to music, or deep in a Factorio factory. I'm passionate about maths, physics, 3D graphics, music, and AI — and I love how they all connect to the things I build.
          </p>
