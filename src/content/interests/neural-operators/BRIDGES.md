...
The closest proposed bridge to learning an integration rule is **KNO + empirical cubature**. [CECM](https://arxiv.org/abs/2308.03877) selects weights and locations for reduced integral evaluation; [manifold-adaptive cubature](https://arxiv.org/abs/2609.03068) makes weights state-dependent. Applying those techniques to a learned kernel's integrand family is worth testing. The graph labels this connection as an analyst hypothesis, separately from bibliography citations.
